...
/**
 * This is the item provider adapter for a {@link thecareunit.Query} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QueryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Query_title_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Query_title_feature", "_UI_Query_type"),
						ThecareunitPackage.Literals.QUERY__TITLE, true, false, false,
	...
	protected void addQueryPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Query_query_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Query_query_feature", "_UI_Query_type"),
						ThecareunitPackage.Literals.QUERY__QUERY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Query) object).getTitle();
	...
	public void notifyChanged(Notification notification) {
		...
		case ThecareunitPackage.QUERY__TITLE:
		case ThecareunitPackage.QUERY__QUERY:
